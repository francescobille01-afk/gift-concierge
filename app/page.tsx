          ...
          {stage === "form" ? (
            <>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:10, marginBottom:20 }}>
                ...
                <button style={socialBtn("#000", "#fff")} onClick={() => handleSocial("oauth_apple")} disabled={busy}>
                  <svg width="17" height="17" viewBox="0 0 814 1000"><path fill="#fff" d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-42.4-155.5-127.4C46 405.8 15.5 229.9 15.5 163.4c0-41.5 15.5-80.4 43.8-109 28.3-28.6 65.3-46.2 103.4-46.2 76.9 0 139.4 51.5 184.8 51.5 43.1 0 111.1-54.6 196.5-54.6zm-217.5-168c41.4 0 93.4 28.5 126.4 72.4 30.5 40.7 46.9 90.7 46.9 140.8 0 8.8-1.6 17.6-2.2 20.4z"/></svg>
                  Continue with Apple
                </button>
                <button style={socialBtn("#1877F2", "#fff")} onClick={() => handleSocial("oauth_facebook")} disabled={busy}>
      ...
      <div style={{ display:"flex", minHeight:"100vh", background:C.bg, color:C.ink, fontFamily:BODY }}>
        ...
        <aside className="gc-brand" style={{ width:"38%", maxWidth:520, background:C.brand, color:"#f3e7d8", padding:"52px 46px", display:"flex", flexDirection:"column", justifyContent:"space-between", position:"relative", overflow:"hidden" }}>
          ...
          <div className="gc-fade" style={{ display:"flex", alignItems:"center", gap:14, position:"relative" }}>
            <div style={{ width:52, height:52, borderRadius:15, background:"linear-gradient(150deg,#e3c089,#c9a26b)", display:"flex", alignItems:"center", justifyContent:"center", boxShadow:"0 6px 18px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.4)" }}>
              <GiftSVG size={28} fill="#4a2a16" />
            </div>
            <div>
