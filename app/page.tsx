...
export default function Home() {
  ...
  const landingActivePhase = landingProgress < .10 ? 0 : landingProgress < .375 ? 1 : landingProgress < .625 ? 2 : landingProgress < .875 ? 3 : 4;
  ...
  return (
    <>
      <style suppressHydrationWarning>{`
        ...
        .gc-v3-phase[data-active=true] .gc-v3-transition{animation:gcPortalOpen 1.4s cubic-bezier(.16,.78,.18,1) both}
        ...
        .gc-v3-phase[data-active=true] .gc-v3-copy{animation:gcCopyArrival .95s .28s cubic-bezier(.14,.84,.22,1) both}
        .gc-v3-phase[data-active=true] .gc-v3-art{animation:gcArtArrival 1.08s .18s cubic-bezier(.12,.82,.18,1) both}
        ...
        .gc-v3-phase-two[data-active=true] .gc-v3-ai-core{animation:gcAiImpact .92s .32s cubic-bezier(.12,.82,.18,1.16) both}.gc-v3-phase-two[data-active=true] .gc-v3-signal{animation:gcSignalPop .58s cubic-bezier(.12,.88,.24,1.2) both}.gc-v3-phase-two[data-active=true] .gc-v3-signal-a{animation-delay:.58s}.gc-v3-phase-two[data-active=true] .gc-v3-signal-b{animation-delay:.7s}.gc-v3-phase-two[data-active=true] .gc-v3-signal-c{animation-delay:.82s}
        ...
        .gc-v3-phase-three[data-active=true] .gc-v3-result-art article{animation:gcResultFan .85s cubic-bezier(.12,.86,.2,1.12) both}.gc-v3-phase-three[data-active=true] .gc-v3-result-art article:nth-child(1){animation-delay:.34s}.gc-v3-phase-three[data-active=true] .gc-v3-result-art article:nth-child(2){animation-delay:.46s}.gc-v3-phase-three[data-active=true] .gc-v3-result-art article:nth-child(3){animation-delay:.58s}
                ...
                <main className="gc-v3-journey">
                  ...
                  <section className="gc-v3-phase gc-v3-phase-one" data-active={landingActivePhase === 1}>
                    ...
                    <div className="gc-v3-phase-inner">
                      ...
                      <button type="button" className="gc-v3-next" onClick={() => scrollLandingTo(".gc-v3-phase-two")}><span className="gc-v3-next-copy"><small>SCORRI O TOCCA</small><strong>Vai al passaggio 2</strong></span><span className="gc-v3-next-arrow">↓</span></button>
                    </div>
                  </section>
                  ...
                  <section className="gc-v3-phase gc-v3-phase-two" data-active={landingActivePhase === 2}>
                    ...
                    <div className="gc-v3-phase-inner gc-v3-reverse">
                      ...
                      <button type="button" className="gc-v3-next" onClick={() => scrollLandingTo(".gc-v3-phase-three")}><span className="gc-v3-next-copy"><small>SCORRI O TOCCA</small><strong>Vai al passaggio 3</strong></span><span className="gc-v3-next-arrow">↓</span></button>
                    </div>
                  </section>
                  ...
                  <section className="gc-v3-phase gc-v3-phase-three" data-active={landingActivePhase === 3}>
                    ...
                    <div className="gc-v3-phase-inner">
                      ...
                      <div className="gc-v3-art gc-v3-result-art" style={{ opacity:.28 + landingPhase3 * .72, transform:`translateY(${40 - landingPhase3 * 40}px)` }}>
                        <article><span>01</span><div>Cucina</div><strong>Macchina per la pasta</strong></article><article><span>02</span><div>Sport</div><strong>Zaino da trekking</strong></article><article><span>03</span><div>Personale</div><strong>Kit su misura</strong></article>
                      </div>
                      <button type="button" className="gc-v3-next" onClick={() => scrollLandingTo(".gc-v3-start")}><span className="gc-v3-next-copy"><small>ULTIMO SCROLL</small><strong>Inizia la ricerca</strong></span><span className="gc-v3-next-arrow">↓</span></button>
                    </div>
                  </section>
