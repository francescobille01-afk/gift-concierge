  ...
  return (
    <>
      <style suppressHydrationWarning>{`
        ...
        .gc-v2-brand{display:flex;align-items:center;gap:11px;padding:5px 12px 5px 6px;border:1px solid rgba(255,244,232,.16);border-radius:18px;background:rgba(9,29,40,.28);box-shadow:0 10px 28px rgba(3,18,27,.2),inset 0 1px 0 rgba(255,255,255,.07);color:#fff4e8;text-align:left;cursor:pointer;backdrop-filter:blur(12px);transition:transform .2s ease,border-color .2s ease,background .2s ease}
        .gc-v2-brand:hover{transform:translateY(-1px);border-color:rgba(255,193,159,.4);background:rgba(9,29,40,.42)}
        .gc-v2-logo{width:44px;height:44px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.38);border-radius:14px;background:linear-gradient(145deg,#ffd0ad 0%,#ef735f 78%);box-shadow:0 9px 22px rgba(239,115,95,.26),inset 0 1px 0 rgba(255,255,255,.7);transform:rotate(-3deg)}
        .gc-v2-wordmark{display:flex;flex-direction:column;gap:2px}.gc-v2-wordmark strong{font-family:'Bricolage Grotesque',sans-serif;font-size:29px;font-weight:750;line-height:.9;letter-spacing:-.045em;text-shadow:0 3px 15px rgba(0,0,0,.22)}.gc-v2-wordmark small{font-family:'Hanken Grotesk',sans-serif;font-size:8px;font-weight:800;line-height:1;letter-spacing:.17em;color:#ffc19f}
        .gc-v2-actions{display:flex;align-items:center;gap:9px}.gc-v2-pill{height:42px;min-width:42px;padding:0 13px;border:1px solid rgba(255,244,232,.28);border-radius:999px;background:linear-gradient(145deg,rgba(255,255,255,.1),rgba(9,29,40,.34));box-shadow:0 9px 24px rgba(3,18,27,.2),inset 0 1px 0 rgba(255,255,255,.1);color:#fff4e8;font:750 12px 'Hanken Grotesk',sans-serif;display:flex;align-items:center;justify-content:center;gap:6px;cursor:pointer;backdrop-filter:blur(12px);transition:transform .2s ease,border-color .2s ease,background .2s ease}.gc-v2-pill:hover{transform:translateY(-1px);border-color:rgba(255,193,159,.52);background:rgba(255,193,159,.12)}.gc-v2-actions>.gc-v2-pill{font-size:20px;color:#ffc19f}
        ...
        .gc-landing-v2-header{position:sticky!important;top:0;z-index:80;box-sizing:border-box;max-width:none!important;height:68px;padding:8px clamp(18px,4vw,56px);background:linear-gradient(180deg,rgba(21,43,56,.98),rgba(21,43,56,.82),transparent);backdrop-filter:blur(14px)}
        .gc-v3-journey{position:relative;margin-top:-68px;color:#fff4e8;background:radial-gradient(circle at 15% 18%,rgba(239,115,95,.1),transparent 20%),linear-gradient(180deg,#17303e,#203746 38%,#274956 72%,#17303e)}
        ...
        .gc-v3-scroll-cue{position:relative;z-index:5;flex:0 0 auto;margin-top:13px;display:flex;flex-direction:column;align-items:center;gap:9px}
        .gc-v3-scroll-cue span{padding:10px 22px;border:1px solid rgba(255,255,255,.72);border-radius:999px;background:#fff4e8;box-shadow:0 10px 28px rgba(3,18,27,.34),0 0 0 5px rgba(239,115,95,.1);color:#17303e;font-size:13.5px;font-weight:850;letter-spacing:.015em;white-space:nowrap;animation:gcScrollLabel 2.4s ease-in-out infinite}
        .gc-v3-scroll-cue b,.gc-v3-next span{width:40px;height:40px;display:grid;place-items:center;border:1.5px solid rgba(255,220,196,.78);border-radius:50%;background:linear-gradient(145deg,#ff9d7e,#ef735f);box-shadow:0 10px 25px rgba(239,115,95,.3);color:#17303e;font-size:19px;animation:gcScrollPulse 1.6s ease-in-out infinite}
        ...
        @media(max-width:900px){.gc-landing-v2-header{height:68px;padding:9px 13px}.gc-v3-journey{margin-top:-68px}.gc-v3-hero{padding-top:84px}.gc-v3-phase-inner{top:68px;min-height:calc(100dvh - 68px)}}
        @media(prefers-reduced-motion:reduce){.gc-v3-hero-glow,.gc-v3-scroll-cue span,.gc-v3-scroll-cue b,.gc-v3-next span,.gc-v3-orbit{animation:none!important}.gc-v3-art{transition:none!important}}
      `}</style>
              ...
              <div className="gc-landing-v2">
                ...
                <main className="gc-v3-journey">
                  <section className="gc-v3-hero">
                    ...
                    <div className="gc-v3-scroll-cue"><span>Scorri verso il basso per continuare</span><b>↓</b></div>
                  </section>
