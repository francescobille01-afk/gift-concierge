  ...
  return (
    <>
      <style suppressHydrationWarning>{`
        ...
        .gc-v3-next span{width:34px;height:34px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.42);border-radius:50%;background:linear-gradient(145deg,#ffad8d,#ef735f);color:#17303e;font-size:16px;animation:gcScrollPulse 1.8s ease-in-out infinite}
        ...
        .gc-v3-phase{position:relative;height:100dvh;min-height:100dvh;border-top:1px solid rgba(255,255,255,.06);scroll-snap-align:start;scroll-snap-stop:always}.gc-v3-phase:before{content:"";position:absolute;left:50%;top:0;bottom:0;width:1px;background:linear-gradient(transparent,rgba(239,115,95,.45) 18%,rgba(239,115,95,.45) 82%,transparent)}
        ...
        .gc-v3-next{position:absolute;left:50%;bottom:26px;z-index:8;min-width:240px;min-height:52px;transform:translateX(-50%);padding:7px 8px 7px 19px;border:1px solid rgba(255,255,255,.7);border-radius:999px;background:#fff4e8;box-shadow:0 14px 34px rgba(3,18,27,.32),0 0 0 6px rgba(239,115,95,.08);display:flex;align-items:center;justify-content:space-between;gap:16px;color:#17303e;font:850 13px 'Hanken Grotesk',sans-serif;white-space:nowrap;cursor:pointer;transition:transform .2s ease,box-shadow .2s ease}.gc-v3-next:hover{transform:translateX(-50%) translateY(-2px);box-shadow:0 18px 38px rgba(3,18,27,.38),0 0 0 8px rgba(239,115,95,.12)}
        ...
        @media(prefers-reduced-motion:reduce){.gc-main.gc-main--flush{scroll-behavior:auto}.gc-v3-hero-glow,.gc-v3-scroll-cue,.gc-v3-scroll-cue span,.gc-v3-scroll-cue b,.gc-v3-next span,.gc-v3-orbit{animation:none!important}.gc-v3-art{transition:none!important}}
      `}</style>
                ...
                <main className="gc-v3-journey">
                  ...
                  <section className="gc-v3-phase gc-v3-phase-one">
                    <div className="gc-v3-phase-inner">
                      ...
                      <button type="button" className="gc-v3-next" onClick={() => scrollLandingTo(".gc-v3-phase-two")}>Vai al passaggio 2 <span>↓</span></button>
                    </div>
                  </section>
                  ...
                  <section className="gc-v3-phase gc-v3-phase-two">
                    <div className="gc-v3-phase-inner gc-v3-reverse">
                      ...
                      <button type="button" className="gc-v3-next" onClick={() => scrollLandingTo(".gc-v3-phase-three")}>Vai al passaggio 3 <span>↓</span></button>
                    </div>
                  </section>
                  ...
                  <section className="gc-v3-phase gc-v3-phase-three">
                    <div className="gc-v3-phase-inner">
                      ...
                      <button type="button" className="gc-v3-next" onClick={() => scrollLandingTo(".gc-v3-start")}>Inizia la ricerca <span>↓</span></button>
                    </div>
                  </section>
